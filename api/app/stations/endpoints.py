...
class StationCBV:
    ...
    @router.get("/bike_count", response_model=list[station_schemas.StationBikeCount])
    def read_stations_bike_count(self, skip: int = 0, limit: int = 100, at_time: datetime = Query(default=None)):
        """
        ...
        """
        return self.service.get_stations_bike_count(skip, limit, at_time)
